...
$this->configs['cache_delext_repo'] = -1;    // Delete extension ".repo"?  4 states option (Default: -1)
$this->configs['cache_delext_gz'] = -1;      // Delete extension ".gz"?  4 states option (Default: -1)
